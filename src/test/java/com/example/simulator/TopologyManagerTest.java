...
public class TopologyManagerTest {
  ...
  public void testLoadMixedTopology() throws Exception {
    ...
    assertEquals("ConsensusAlgorithm", nodes.get("coordinator").getProgramName());
    assertEquals("BroadcastAlgorithm", nodes.get("ring-node-0").getProgramName());
    assertEquals("LeaderElection", nodes.get("fc-node-0").getProgramName());
  }

...
export DROP_RATE=${jitterConfig.drop_rate}
export DELAY_MS=${jitterConfig.delay_ms}
  ...
  return (
    ...
    >
      ...
      {nodes.length === 0 && (
        ...
        >
          <strong>Warning:</strong> No nodes configured. Please add nodes to the
          topology before starting simulation.
        </div>
      )}
